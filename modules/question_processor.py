...
class QuestionAnalysis:
    ...
    language: str = "ar"  # Changed default to Arabic
        ...
        try:
            ...
            for lang in self.supported_languages:
                try:
                    ...
                    nltk_lang = lang_mapping.get(lang, 'arabic')  # Changed default to Arabic
